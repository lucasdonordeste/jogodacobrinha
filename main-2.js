...
function init() {
  ...
  // gameover messages
  var msgsSelf = [];
  msgsSelf[0] = "Você morreu. Arriégua!";
  msgsSelf[1] = "Comer-se não é uma solução";
  msgsSelf[2] = "Autocanibalismo não da certo"; 
  msgsSelf[3] = "OK, você provavelmente deveria voltar ao trabalho";  
  
  var msgsWall = [];
  msgsWall[0] = "Aquilo era um muro, você está morto.";
  msgsWall[1] = "Minha avó dobrou essa pontuação";
  msgsWall[2] = "Você morreu. Arriégua!";
  msgsWall[3] = "OK, você provavelmente deveria voltar ao trabalho";
  msgsWall[4] = "Você pode fazer melhor.";
  ...
  reset = function() {
    ...
    function gameover() {
      ...
      tweet.href='http://twitter.com/share?text=Eu consegui ' +score+ ' no Jogo da cobrinha Nordestina! Venha você tambem nesse jogo arretado de bom, basta acessar jogodacobrinhanordestina.netlify.app - - - @agenciaarretada';
